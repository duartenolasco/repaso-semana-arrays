...
void seleccion(){
    ...
    switch(opcion){
        case 1: sumaelementos();
            break;
        case 2: mayorelementos();
            break;
        case 3: invertirorden();
            break;
        case 4: mostrarsumaelementos();
            break;
        case 5: numerodevecesfruta();
            break;
